...
sed -e "s|__NODE_BIN__|$(which node)|" -e "s|__PROJECT_DIR__|$PWD|" \
  collector/io.github.itzzjb.starlink.historian.plist \
  > ~/Library/LaunchAgents/io.github.itzzjb.starlink.historian.plist
launchctl load ~/Library/LaunchAgents/io.github.itzzjb.starlink.historian.plist
```

Stop / uninstall:

```
launchctl unload ~/Library/LaunchAgents/io.github.itzzjb.starlink.historian.plist
```
