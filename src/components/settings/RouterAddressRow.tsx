  ...
  return (
    <>
      <SettingRow
        ...
        info={`Starlink looks for your router at this address. Change it only if the router's subnet was moved in the Starlink app, or your kit is in bypass mode behind a third-party router. Clearing the box returns to ${fallback}.`}
        infoSeverity='warn'
        ...
        note={
          refused ? (
            ...
            `Starlink is using ${stored}. Clear the box to go back to ${fallback}.`
          ) : undefined
        }
      >
        <Input
