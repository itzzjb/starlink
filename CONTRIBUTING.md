...
Thanks for taking an interest. The app talks to real Starlink hardware, so a
...
in this file — it's appreciated. The project is better for having more eyes on it,
