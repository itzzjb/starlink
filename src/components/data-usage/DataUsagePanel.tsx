...
// range tabs, stacked down/up bars. Clearly labeled as measured by Starlink
  ...
  if (unavailable) {
    return (
      <Callout className='mt-2.5'>
        ...
        and Starlink will meter traffic from now on.
      </Callout>
    );
  }
  ...
  return (
    <div>
      ...
      <Explainer title='How is this measured?'>
        Starlink integrates the dish's own per-second throughput telemetry into per-minute volume,
